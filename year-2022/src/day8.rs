...
/// height or taller than the tree under consideration. (If a tree is right on the
/// edge, at least one of its viewing distances will be zero.)
///
/// The Elves don't care about distant trees taller than those found by the rules
/// above; the proposed tree house has large [eaves](https://en.wikipedia.org/wiki/Eaves)
...
const PART1_EX_ANSWER: &str = "21";
const PART1_ANSWER: &str = "1672";
const PART2_EX_ANSWER: &str = "8";
const PART2_ANSWER: &str = "327180";
