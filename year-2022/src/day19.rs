...
/// [geodes](https://en.wikipedia.org/wiki/Geode) around the pond. Perhaps you could
/// use the obsidian to create some *geode-cracking robots* and break them open?
///
/// To collect the obsidian from the bottom of the pond, you'll need waterproof *obsidian-collecting
/// robots*. Fortunately, there is an abundant amount of clay nearby that you can
/// use to make them waterproof.
///
/// In order to harvest the clay, you'll need special-purpose *clay-collecting robots*.
/// To make any type of robot, you'll need *ore*, which is also plentiful but in
/// the opposite direction from the clay.
///
...
///
/// Each robot can collect 1 of its resource type per minute. It also takes one minute
/// for the robot factory (also conveniently from your pack) to construct any type
/// of robot, although it consumes the necessary resources available when construction
/// begins.
///
...
/// assortment of blueprints are provided one blueprint per line.)
///
...
/// ```
///
/// However, blueprint 2 from the example above is still better; using it, the largest
/// number of geodes you could open in 32 minutes is `*62*`.
///
...
/// of geodes you could open using each of the first three blueprints. *What do you
...
const PART1_EX_ANSWER: &str = "33";
const PART1_ANSWER: &str = "1150";
const PART2_EX_ANSWER: &str = "3472";
const PART2_ANSWER: &str = "37367";
