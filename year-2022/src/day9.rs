...
/// yourself by modeling rope physics; maybe you can even figure out where *not*
/// to step.
///
...
/// at least once*. In this diagram, `s` again marks the starting position (which
/// the tail also visited) and `#` marks other positions the tail visited:
///
/// ```
/// ..##..
/// ...##.
...
const PART1_ANSWER: &str = "6266";
const PART2_EX_ANSWER: &str = "1";
const PART2_ANSWER: &str = "2369";
