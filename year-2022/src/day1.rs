...
mod test {
    ...
    const PART1_EX_ANSWER: i64 = 24000;
    const PART1_ANSWER: i64 = 67016;
    const PART2_EX_ANSWER: i64 = 45000;
    const PART2_ANSWER: i64 = 200116;

    #[test]
    fn test_part1_ex() {
        let ex_input = std::fs::read_to_string("./inputs/day1-test.txt").unwrap();
